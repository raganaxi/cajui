...
const meta: Meta<typeof ItemCustomizer> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Personalizador visual de productos estilo Cafenio. Renders en vaso SVG con escalado proporcional, sliders de endulzante, y checkboxes interactivos para toppings y leches.',
      },
    },
  },
}
...
export const Coffee: Story = {
  ...
  args: {
    product: {
      ...
      price: 32.00,
      description: 'Café de grano recién molido de tueste oscuro con agua caliente.',
    },
    onConfirm: (data) => {
      alert(`Confirmado: ${data.product.name} (${data.size.label}) - Total: ${data.totalPrice.toFixed(2)}`)
    },
...
export const Frappuccino: Story = {
  ...
  args: {
    product: {
      ...
      name: 'Frapuccino de Caramelo',
      price: 52.00,
      description: 'Bebida helada de café frappe con jarabe de caramelo y chispas.',
    },
    modifiers: [
      {
        id: 'sweetness',
      ...
      },
      {
        ...
        options: [
          { id: 'whip', label: 'Crema Batida Extra', extraPrice: 8, defaultSelected: true },
          { id: 'caramel', label: 'Doble Caramelo Drizzle', extraPrice: 7, defaultSelected: true },
