    ...
    <div className="w-screen h-screen bg-slate-900 flex items-center justify-center relative">
      <div className="absolute inset-0 flex flex-col justify-between p-6 opacity-30 pointer-events-none">
        ...
        <main className="flex-1 grid grid-cols-3 gap-4 py-6">
          <div className="border border-white/10 rounded-xl p-4">Panel de Categorías</div>
          <div className="border border-white/10 rounded-xl p-4 col-span-2">Listado de Productos</div>
        </main>
      </div>
      <RegisterLocked {...args} />
    </div>
...
export const WithShiftSummary: Story = {
  args: {
    ...
    companyBranding: <Branding companyName="SuperMarket Cloud" size="sm" themeColor="#06b6d4" />,
    shiftSummary: {
      salesCount: 42,
      salesTotal: 8450.75,
    },
