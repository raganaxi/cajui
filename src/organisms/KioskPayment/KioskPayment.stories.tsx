...
const meta: Meta<typeof KioskPayment> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Pantalla de pago interactiva estilo Kiosco / Costco Auto-Cobro. Presenta opciones de pago gigantes y guía al usuario con prompts e ilustraciones animadas de la terminal física.',
      },
    },
  },
}
...
export const Default: Story = {
  args: {
    amount: 1485.50,
    onSuccess: (methodId) => alert(`Pago completado exitosamente con: ${methodId}`),
