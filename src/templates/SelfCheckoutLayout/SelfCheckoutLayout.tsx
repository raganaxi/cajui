...
import {
	PaymentMethodGroup,
	type PaymentType,
} from "@/atoms/PaymentMethod/PaymentMethod";
...
export function SelfCheckoutLayout({
	...
	return (
		<div
			className={cn(
				"flex h-screen w-full bg-transparent text-white font-pos",
				className,
			)}
		>
				...
				{step === "payment" && (
					<div className="flex flex-1 flex-col gap-4 p-4">
						...
						<Button
							...
							block
							onClick={() =>
								paymentMethod === "cash" ? setStep("cash") : setStep("done")
							}
