...
const meta: Meta<typeof PriceDisplay> = {
  ...
  argTypes: {
    ...
    currency: { control: 'select', options: ['MXN', 'USD', 'EUR', 'COP', 'ARS'] },
    size: { control: 'select', options: ['xs', 'sm', 'md', 'lg', 'xl', '2xl'] },
    variant: { control: 'select', options: ['default', 'positive', 'negative', 'muted', 'highlight'] },
  },
}
...
export const Discount: Story = {
  ...
  render: () => (
    <div className="flex items-center gap-3">
      <PriceDisplay value={1499.99} currency="MXN" size="md" variant="muted" strikethrough />
      <PriceDisplay value={999.99} currency="MXN" size="lg" variant="positive" />
    </div>
  ),
}
