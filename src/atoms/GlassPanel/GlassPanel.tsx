...
const glassPanelVariants = cva(
  'relative',
  {
    ...
    compoundVariants: [
      { tint: 'white', strength: 'subtle', className: 'bg-white/[0.05] border-white/[0.10]' },
      { tint: 'white', strength: 'strong', className: 'bg-white/[0.18] border-white/[0.32] [box-shadow:0_12px_40px_rgba(0,0,0,0.18),inset_0_1px_0_rgba(255,255,255,0.38)]' },
    ],
    defaultVariants: {
      blur:     'lg',
      tint:     'white',
...
export function GlassPanel({
  ...
  const padClass = typeof padding === 'boolean'
  ...
  return (
    <Tag
      className={cn(
        glassPanelVariants({ blur, tint, strength, radius, shadow: shadow as boolean | undefined }),
        'border',
        padClass,
