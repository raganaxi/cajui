    ...
    <div className="p-8 bg-slate-900 rounded-xl flex flex-col items-center justify-center min-h-[200px] w-96 text-white border border-white/5">
      ...
      >
        <p className="text-white/80">
          ¿Estás seguro de que deseas eliminar este registro de venta? Esta acción no se puede deshacer y quedará registrada en la bitácora de auditoría.
        </p>
      </Dialog>
    </div>
  );
...
function FormDialogDemo() {
  ...
  return (
    <div className="p-8 bg-slate-900 rounded-xl flex flex-col items-center justify-center min-h-[200px] w-96 text-white border border-white/5">
      <p className="text-sm text-white/60 mb-4 text-center">
        Haz clic abajo para abrir un diálogo de formulario de creación (inspirado en Element UI).
      </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col gap-1.5">
              <label htmlFor="nombre" className="text-xs font-semibold text-white/70">
            ...
            <div className="flex flex-col gap-1.5">
              <label htmlFor="rfc" className="text-xs font-semibold text-white/70">
                RFC o Tax ID
              </label>
              <input
                id="rfc"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col gap-1.5">
              <label htmlFor="telefono" className="text-xs font-semibold text-white/70">
            ...
            <div className="flex flex-col gap-1.5">
              <label htmlFor="tipoCliente" className="text-xs font-semibold text-white/70">
                Tipo de Cliente
              </label>
              <select
                id="tipoCliente"
                ...
                onChange={handleInputChange}
              >
                <option value="General" className="bg-slate-950 text-white">General / Mostrador</option>
                <option value="Frecuente" className="bg-slate-950 text-white">Cliente Frecuente (VIP)</option>
                <option value="Mayorista" className="bg-slate-950 text-white">Distribuidor / Mayorista</option>
              </select>
            </div>
          </div>

          <div className="flex flex-col gap-1.5">
            <label htmlFor="limiteCredito" className="text-xs font-semibold text-white/70">
