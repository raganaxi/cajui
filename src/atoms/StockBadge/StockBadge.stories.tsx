...
const meta: Meta<typeof StockBadge> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Indicador visual de nivel de stock. Se calcula automáticamente a partir de `quantity`, `lowThreshold` y `outThreshold`.',
      },
    },
  },
}
...
export const LowStock: Story = { name: 'Stock bajo', args: { quantity: 3, showCount: true } }
