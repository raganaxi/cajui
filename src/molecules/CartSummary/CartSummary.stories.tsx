...
const meta: Meta<typeof CartSummary> = {
  ...
  parameters: {
    docs: {
      description: {
        component: 'Panel de totales del carrito. Calcula subtotal, descuento y IVA automáticamente. Incluye botón de cobro.',
      },
    },
  },
}
...
export const Default: Story = {
  args: { items: ITEMS, onCheckout: (total) => alert(`Cobrar: $${total.toFixed(2)}`) },
