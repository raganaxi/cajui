...
const DEFAULT_STEPS: OrderStatusValue[] = [
	"pending",
	"preparing",
	"ready",
	"delivered",
						...
						<div className="flex flex-col items-center gap-1">
							<div
								className={cn(
									...
									isPast
										...
										: isCurrent
											? "border-2 border-caj-primary text-caj-primary bg-caj-primary/10"
							...
							<span
								className={cn(
									...
									isCurrent ? "text-caj-primary" : "text-white/50",
								)}
							>
								{LABELS[step]}
							</span>
						...
						{idx < steps.length - 1 && (
							<div
								className={cn(
									...
									idx < currentIdx ? "bg-caj-primary" : "bg-white/15",
								)}
							/>
						)}
					</div>
