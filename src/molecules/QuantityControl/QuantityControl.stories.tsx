...
const meta: Meta<typeof QuantityControl> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Control +/− de cantidad para líneas de carrito. Soporta mínimo, máximo y paso configurable.',
      },
    },
  },
}
...
export const WithMax: Story = { name: 'Con máximo (10)', render: () => <Demo max={10} /> }

export const InteractiveIncrement: Story = {
  render: () => <Demo min={1} max={5} />,
  play: async ({ canvas, userEvent }) => {
    const input = canvas.getByRole('spinbutton', { name: 'Cantidad' }) as HTMLInputElement;
