		...
		<div className={cn("flex h-full gap-3", className)}>
			...
			<div className="flex min-w-0 flex-1 flex-col gap-3">
				...
				<div className="relative">
					<svg
						className="pointer-events-none absolute left-3 top-1/2 h-5 w-5 -translate-y-1/2 text-caj-text-muted"
						fill="none"
						viewBox="0 0 24 24"
						stroke="currentColor"
						aria-hidden="true"
				...
				{/* Product grid */}
				<div ref={productsPanelRef} className="flex-1 overflow-y-auto">
